const Maintenaceselect = () => {
  return (
    <>
      <div className=" pb-5">
        <div className="container pt-5">
          <span className="d-flex fs-1 justify-content-center box-colors py-5 Sacramento_font">How Does It Work?</span>
...
export default Maintenaceselect;
