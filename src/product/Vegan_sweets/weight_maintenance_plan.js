...
const Weightmaintenance = () => {
  ...
  useEffect(() => {
    const loadVegan = async () => {
      try {
        const loadVegan = await fetch("./data/weight_maintenance_plan.json");
          ...
          <div className="row g-0">
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <div className="row row-cols-1 row-cols-md-1 row-cols-lg-3 row-cols-sm-1 g-4 mt-3row row-cols-1 row-cols-md-3 g-4 mt-3">
                {vegan.map((stro) => {
                  return (
